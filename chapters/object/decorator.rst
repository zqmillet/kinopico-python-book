...
.. literalinclude:: /examples/object/decorator/demo_1.py
   :caption: ``examples/object/decorator/demo_1.py``

.. _decorator_demo_2:

.. literalinclude:: /examples/object/decorator/demo_2.py
   :caption: ``examples/object/decorator/demo_2.py``
...
.. python-disassembly:: /examples/object/decorator/demo_1.py
   :caption: ``examples/object/decorator/demo_1.py``

.. _decorator_demo_2_dis:

.. python-disassembly:: /examples/object/decorator/demo_2.py
   :caption: ``examples/object/decorator/demo_2.py``
...
.. literalinclude:: /examples/object/decorator/time_decorator.py
   :caption: ``examples/object/decorator/time_decorator.py``

.. bash:: python3 examples/object/decorator/time_decorator.py
   :caption: ``examples/object/decorator/time_decorator.py`` 执行结果
...
.. literalinclude:: /examples/object/decorator/time_decorator_with_arguments.py
   :caption: ``examples/object/decorator/time_decorator_with_arguments.py``

.. bash:: python3 examples/object/decorator/time_decorator_with_arguments.py
   :caption: ``examples/object/decorator/time_decorator_with_arguments.py`` 执行结果
...
.. python-disassembly:: /examples/object/decorator/time_decorator_with_arguments.py
   :caption: ``examples/object/decorator/time_decorator_with_arguments.py``
...
.. literalinclude:: /examples/object/decorator/print_closure.py
   :caption: ``examples/object/decorator/print_closure.py``

其运行结果如下所示, 根据运行结果, 我们可以得到几个结论:

.. bash:: python3 examples/object/decorator/print_closure.py
   :caption: ``examples/object/decorator/print_closure.py`` 执行结果
...
.. literalinclude:: /examples/object/decorator/time_decorator_with_arguments_v2.py
   :caption: ``examples/object/decorator/time_decorator_with_arguments_v2.py``

.. bash:: python3 examples/object/decorator/time_decorator_with_arguments_v2.py
   :caption: ``examples/object/decorator/time_decorator_with_arguments_v2.py`` 执行结果
